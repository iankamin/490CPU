...
#
# Generated by Vivado on Tue May 15 14:31:24 -0400 2018
...
# Script info
echo -e "memory.sh - Script generated by export_simulation (Vivado v2017.4.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_1 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot memory xil_defaultlib.memory xil_defaultlib.glbl -log elaborate.log
}
